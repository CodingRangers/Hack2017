...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 22, 2017 at 05:30 PM
...
(2, 'css', 2, 'img/magics/css.png', 50, 'very sad magic', 2, 2),
(3, 'php', 1, 'img/magics/php.png', 120, 'Very strong spell against demons', 3, 2),
(4, 'laravel', 1, 'img/magics/laravel.png', 150, 'Very strong spell against demons', 3, 2),
(5, 'sword strike', 1, 'img/magics/knight_sword_strike.png', 100, '', 1, 1),
(6, 'shield', 2, 'img/magics/knight_shield.png', 50, '', 2, 1),
...
--
ALTER TABLE `characters`
  MODIFY `char_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
--
